...
<body>
    <div class="navbar">
        <div class="logo flex">
            ...
            <h1>Welcome to <% out.println(session.getAttribute("resName")); %></h1>
        <div class="links">
...
<div class="restarents">
   ...
   <!-- <a href="CartServ"> -->
    <div class="card">
        ...
        <div class="rest">
            <img class="restrent-image" src="<%= menu.getImgPath()%>" alt="">
            <h2 class="restarent-name"><%= menu.getItemName()%></h2>
        </div>
        <div class="details">
            <div class="data1 flex2 padd" style="color: black;">
                <p><%= menu.getPrice()%></p>
                <%-- <p><i class="fa-solid fa-star"></i><%= menu.getDescription() %></p> --%>
            </div>
            ...
            <form action="CartServ" method="post">
                 <input type="number" name="itemQuantity" min="1" max="100" required>
                 <input type="hidden" name="itemId" value="<%= menu.getMenuId()%>">
                 <input type="hidden" name="act" value="add">
                 <%-- <input type = "hidden" name = menuId value = "<%=menu.get %>"> --%>
                 <button type="submit">Add to cart</button>
            </form>
       		</div>
        </div>
        <button style="background: rgb(205, 205, 205); border: 0; outline: 0; width: 83%; margin-left: 20px; padding: 4px 0; margin-top:20px; border-radius: 6px;"></button>
    </div>
   <!--  </a> -->
    <%
                }
